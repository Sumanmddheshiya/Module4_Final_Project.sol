...
contract MyToken {
    ...
    mapping(address => bool) private hasShirt;
    mapping(address => bool) private hasTop;
    mapping(address => bool) private hasSuit;
    mapping(address => bool) private hasSaree;
    ...
    function redeemTShirt(uint256 quantity) private {
        ...
        require(!hasShirt[msg.sender], "T-shirt already redeemed");

        hasTop[msg.sender] = true;
    ...
    function redeemPants(uint256 quantity) private {
        ...
        require(!hasSuit[msg.sender], "Pants already redeemed");

        hasSaree[msg.sender] = true;
        balances[msg.sender] -= requiredBalance;
    ...
    function redeemCap(uint256 quantity) private {
        ...
        require(!hasSuit[msg.sender], "Cap already redeemed");

        hasSuit[msg.sender] = true;
        balances[msg.sender] -= requiredBalance;
    ...
    function redeemShoes(uint256 quantity) private {
        ...
        require(!hasSaree[msg.sender], "Shoes already redeemed");
